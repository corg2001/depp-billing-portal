...
export class PaymentService {
  ...
  public getPaymentHistory(
    paymentHistory$: Subject<PaymentHistoryInterface[]>,
    completion$: Subject<boolean>,
    error$: Subject<boolean>,
    errorMessage$: Subject<any>
  ): void {
    // const vendorId: string = this._configService.getPartyId();
    const vendorId = 'V000000149';
    // const companyInfo = 'eyJjb21wYW55X2lkIjoiSUwwMyIsImJyYW5kcyI6eyJicmFuZF9pZHMiOlsiSFdBIl19fQ';
  ...
  public paymentHistorySuccessHandler(
    ...
    error$.next(false);
    paymentHistory$.next(this._paymentHistoryFactoryService.getPaymentHistoryFromPayload(data));
  }
