...
extends BaseDiagnosisFormComponent
  ...
  constructor(
    ...
    protected _plumbingFormFactory: PlumbingFormFactoryAbstract,
  ...
  private _createForm(): FormGroup {
    return this._formBuilder.group({
      ...
      plumbingClaimInfo: this._formBuilder.group({
        plumbing: this._plumbingFormFactory.getPlumbingFormGroup(),
        garbageDisposal: this._plumbingFormFactory.getGarbageDisposalFormGroup(),
        stoppageClog: this._plumbingFormFactory.getStoppageClogFormGroup(),
        sumpPump: this._plumbingFormFactory.getSumpPumpFormGroup()
      }),
