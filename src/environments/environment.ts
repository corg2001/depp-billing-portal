...
const custumerPortalUrl: string = `https://hwa-portal-${env}.digitaltest.directenergy.net/`;
const realtorPortalUrl: string = `https://hwa-realtor-portal-${env}.digitaltest.directenergy.net/`;
